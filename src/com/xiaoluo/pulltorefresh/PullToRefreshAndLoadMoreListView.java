 ...
 * 
 * @author xiaoluo 
 * @version create time: 2014年8月21日 - 下午5:35:44
 */
public class PullToRefreshAndLoadMoreListView extends PullToRefreshListView {

	protected static final String TAG = "PullToRefreshAndLoadMoreListView";
	...
	public PullToRefreshAndLoadMoreListView(Context context, AttributeSet attrs, int defStyle) {
